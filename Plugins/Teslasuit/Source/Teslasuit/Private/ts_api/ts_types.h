...
/*
   \brief Handler to current feedback data.
*/
...
/*!
    ...
    A callback will be called after subscribing and starting PPG streaming.
    Received processed PPG data can be parsed with #ts_ppg_get_heart_rate

    \param[in] dev handle to attached device
    \param[in] ppg_data handle to processed PPG data
    \param[in] user_data opaque pointer for user data
    \sa ts_ppg_set_update_callback, ts_ppg_get_heart_rate
*/
...
/*!
    ...
    #ts_ppg_raw_get_blue_data, #ts_ppg_raw_get_green_data
...
/*!
    \brief Current feedback data update callback.

    A callback will be called after subscribing and starting current feedback streaming.
    Received data can be parsed with #ts_current_feedback_get_channel_frequency_complex_value.

    \param[in] dev handle to attached device
    \param[in] feedback_data handle to current feedback data
    \param[in] user_data opaque pointer for user data
    \sa ts_current_feedback_set_update_callback, ts_current_feedback_get_channel_value
*/
